# DEPRECATED — local costmap generation has been consolidated into the
# grid_mapping package.  Use `grid_mapping.occupancy_grid_original` instead.
...
class OccupancyGridNode(Node):
    def __init__(self):
        ...
        self.map_pub          = self.create_publisher(OccupancyGrid, '/map_dwa',          10)
        self.inflated_map_pub = self.create_publisher(OccupancyGrid, '/inflated_map_dwa', 10)
